...
![](../../../_assets/android-basic_reverse-dynamic-figure-debug_run_android.png)
...
![](../../../_assets/android-basic_reverse-dynamic-figure-debug_run_setup.png)

主要是选择了三个 Events，使得我们的程序可以在入口点，线程启动时，library加载时自动停止。当然，也可以都进行选择。

启动程序后，如下

![](../../../_assets/android-basic_reverse-dynamic-figure-debug_run_run.png)
...
>
>    ![](../../../_assets/android-basic_reverse-dynamic-figure-debug_run_linker.png)
>
...
![](../../../_assets/android-basic_reverse-dynamic-figure-debug_setup.png)
...
![](../../../_assets/android-basic_reverse-dynamic-figure-debug_attach_process.png)

然后ok确定即可。

这时我们可以看到我们已经 attach 成功了。

![](../../../_assets/android-basic_reverse-dynamic-figure-debug_attach_libc.png)

这时候我们再点击 Debugger-Debugger options，设置相关选项如下

![](../../../_assets/android-basic_reverse-dynamic-figure-debug_attach_setup.png)
...
![](../../../_assets/android-basic_reverse-dynamic-figure-ddms.png)
...
![](../../../_assets/android-basic_reverse-dynamic-figure-jdb-debugging.png)
...
![](../../../_assets/android-basic_reverse-dynamic-figure-debug_attach_mobile.png)
...
![](../../../_assets/android-basic_reverse-dynamic-figure-debug_attach_jnistring.png)

可以看出其偏移为 0xc38。

我们再在之前的调试的 IDA 中运行 F9 直到怎么按都不再运行，我们会看到程序断在 linker 处

![](../../../_assets/android-basic_reverse-dynamic-figure-debug_attach_linker.png)
