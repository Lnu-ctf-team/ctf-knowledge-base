...
![uninitialized-storage-pointer-error](../../../_assets/blockchain-ethereum-attacks-figure-uninitialized-storage-pointer-error.png)

在我们部署后，首先使用 setValue 函数将 a 和 b 的值分别设为 1 和 0x10aA1C20aD710B823f8c1508cfC12D5d1199117E，可以从交易中发现设置成功：

![uninitialized-storage-pointer-setvalue](../../../_assets/blockchain-ethereum-attacks-figure-uninitialized-storage-pointer-setvalue.png)
...
![uninitialized-storage-pointer-attack](../../../_assets/blockchain-ethereum-attacks-figure-uninitialized-storage-pointer-attack.png)
...
![uninitialized-storage-pointer-error2](../../../_assets/blockchain-ethereum-attacks-figure-uninitialized-storage-pointer-error2.png)

在我们部署后，首先使用 setValue 函数将 a 的值设为 1，可以从交易中发现设置成功：

![uninitialized-storage-pointer-setvalue2](../../../_assets/blockchain-ethereum-attacks-figure-uninitialized-storage-pointer-setvalue2.png)
...
![uninitialized-storage-pointer-attack2](../../../_assets/blockchain-ethereum-attacks-figure-uninitialized-storage-pointer-attack2.png)
