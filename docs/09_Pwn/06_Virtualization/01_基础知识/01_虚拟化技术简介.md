...
![overview.png](../../../_assets/pwn-virtualization-basic-knowledge-figure-overview.png)
...
![layer.png](../../../_assets/pwn-virtualization-basic-knowledge-figure-layer.png)
...
![](../../../_assets/pwn-virtualization-basic-knowledge-figure-computer.png)
...
![](../../../_assets/pwn-virtualization-basic-knowledge-figure-virt-hardware-layer.png)
...
- `Type I` ：**Hypervisor 直接运行在硬件上，即以 Hypervisor 作为 Host OS 直接管控硬件资源**。例如 `VMware ESXI` 便是采用此种架构的 Hypervisor
  ...
  ![Type I VMM](../../../_assets/pwn-virtualization-basic-knowledge-figure-type-i-vmm.png)

- `Type II`：**Hypervisor 运行在传统的操作系统上，与其他应用程序并行运行**。例如 `Qemu` 与 `VMware Player` 便是采用此种架构的 Hypervisor

  ![Type II VMM](../../../_assets/pwn-virtualization-basic-knowledge-figure-type-ii-vmm.png)
...
![](../../../_assets/pwn-virtualization-basic-knowledge-figure-trap-emulate.png)
