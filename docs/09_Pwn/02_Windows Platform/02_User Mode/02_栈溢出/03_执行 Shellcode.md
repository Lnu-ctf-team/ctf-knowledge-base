...
![demo](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo2-1.png)
...
![demo](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo2-2.png)



输入的字符串会被复制到栈中 **0012FAE4** 的位置。

![demo](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo2-3.png)



因为通过合理的 padding 控制了返回地址到 **0012FAE4**，所以在函数返回时寄存器 **EIP** 的值为 **0012FAE4**，这时系统会认为栈中的数据为机器码，程序就会执行地址为 **0012FAE4** 的代码。

![demo](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo2-4.png)
...
![demo](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo2-5.png)
