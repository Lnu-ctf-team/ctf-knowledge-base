...
![demo1](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo1-1.png)
...
![demo2](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo1-2.png)

![demo3](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo1-3.png)
...
![demo4](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo1-4.png)

这次我们输入 8 个 a 验证一下是否如我们想的一样：**字符串的结束符会溢出到 strcmp 的返回值**。可以看到 strcmp 的返回值还是 1。

![demo5](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo1-5.png)
...
![demo6](../../../../_assets/pwn-windows-user-mode-stackoverflow-figure-demo1-6.png)
