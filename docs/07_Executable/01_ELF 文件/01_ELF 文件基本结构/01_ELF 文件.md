...
![](../../../_assets/executable-elf-structure-figure-object_file_format.png)
...
![](../../../_assets/executable-elf-structure-figure-elf-layout.png)
...
![](../../../_assets/executable-elf-structure-figure-elfdata2lsb.png)

`ELFDATA2MSB`编码使用补码，最高有效位（Most Significant Byte）占用最低地址。

![](../../../_assets/executable-elf-structure-figure-elfdata2msb.png)
...
![](../../../_assets/executable-elf-structure-figure-segment_flag_bits.png)
...
![](../../../_assets/executable-elf-structure-figure-segment-permission.png)
...
![](../../../_assets/executable-elf-structure-figure-text_segment.png)

数据段包含可写的数据以及以及指令，通常来说，包含以下内容

![](../../../_assets/executable-elf-structure-figure-data_segment.png)
...
![](../../../_assets/executable-elf-structure-figure-ELF-Walkthrough.png)
