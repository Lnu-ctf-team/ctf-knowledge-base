...
![](../../../_assets/executable-elf-figure-run_static_linking.png)

## 动态执行

![](../../../_assets/executable-elf-figure-run_dynamic_linking.png)



这里给出另外一张更加细节的图片。

![image-20181201152204864](../../../_assets/executable-elf-figure-program-running-overview.png)
...
- 将program header 中记录的相应的段映射到内存中。program header中有以下重要信息
  ...
  ![](../../../_assets/executable-elf-figure-memory_mapping.png)
