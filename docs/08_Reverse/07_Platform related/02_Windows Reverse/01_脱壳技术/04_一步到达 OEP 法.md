...
![direct2oep_01.png](../../../../_assets/reverse-platform-windows-unpack-figure-direct2oep_01.png)

在本例中, 当搜索到的`popad`不符合我们的要求时, 可以按下`ctrl+l`来搜索下一个匹配处, 大概按下个三四次, 我们找到了跳转到OEP的位置处.

![direct2oep_02.png](../../../../_assets/reverse-platform-windows-unpack-figure-direct2oep_02.png)
