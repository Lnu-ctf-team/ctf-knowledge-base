...
![sfx_01.png](../../../../_assets/reverse-platform-windows-unpack-figure-sfx_01.png)

然后切换到`SFX`标签页, 点选"字节方式跟踪真正入口处(速度非常慢)"

![sfx_02.png](../../../../_assets/reverse-platform-windows-unpack-figure-sfx_02.png)

重载程序，程序已经停在了代码入口点, 并且也不需要对OEP进行重新分析.

![sfx_03.png](../../../../_assets/reverse-platform-windows-unpack-figure-sfx_03.png)
