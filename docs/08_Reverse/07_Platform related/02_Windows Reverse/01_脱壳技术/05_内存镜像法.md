...
![memory_01.png](../../../../_assets/reverse-platform-windows-unpack-figure-memory_01.png)

按下`Alt+M`打开内存镜像, 找到资源段, 也就是`地址=00407000`, `大小=00005000`的`.rsrc`段, 选中F2下断

![memory_02.png](../../../../_assets/reverse-platform-windows-unpack-figure-memory_02.png)

回到CPU窗口, 按下F9运行, 程序断在了`0040D75F`处

![memory_03.png](../../../../_assets/reverse-platform-windows-unpack-figure-memory_03.png)

再次按下`Alt+M`打开内存镜像, 对`.text`代码段下断

![memory_04.png](../../../../_assets/reverse-platform-windows-unpack-figure-memory_04.png)

再继续运行, 程序断在了`004010CC`处, 也就是OEP

![memory_05.png](../../../../_assets/reverse-platform-windows-unpack-figure-memory_05.png)
