...
![run.png](../../../_assets/reverse-platform-linux-figure-2014_hitb-run.png)

程序似乎在一直打印着一些句子. 并且没有停止下来的迹象. 我们就用IDA打开来看一下. 首先按下`Shift+F12`查找字符串.

![ida_strings.png](../../../_assets/reverse-platform-linux-figure-2014_hitb-ida_strings.png)
...
![ida_patch.png](../../../_assets/reverse-platform-linux-figure-2014_hitb-ida_patch.png)
...
![ida_apply.png](../../../_assets/reverse-platform-linux-figure-2014_hitb-ida_apply.png)
...
![LD_PRELOAD.png](../../../_assets/reverse-platform-linux-figure-2014_hitb-ld_preload.png)
