...
![](../../_assets/misc-other-figure-pyc-struct.png)
...
![feature](../../_assets/misc-other-figure-feature.png)
...
![test](../../_assets/misc-other-figure-test-01.png)
...
![test](../../_assets/misc-other-figure-test-02.png)
...
![import-test](../../_assets/misc-other-figure-import-test.png)
...
![import-error](../../_assets/misc-other-figure-import-error.png)

报 `ImportError` 的错误，似乎是没有加载到对象 `D` ，而我们将 `from B import D` 改成 `import B` ，我们似乎就能执行成功了。

![import-success](../../_assets/misc-other-figure-import-success.png)
...
![PyImportFlow](../../_assets/misc-other-figure-PyImportFlow.png)
...
![tree](../../_assets/misc-other-figure-tree.png)
...
![test-success](../../_assets/misc-other-figure-test-success.png)
...
![error](../../_assets/misc-other-figure-error.png)
...
![flag](../../_assets/misc-other-figure-flag.png)
...
![carry-bytes](../../_assets/misc-other-figure-carry-bytes.png)
...
![payload-embedded](../../_assets/misc-other-figure-payload-embedded.png)

现在我们可以用 `ls` 命令查看磁盘目录，嵌入了 `Payload` 的文件( `carrier` 文件)和原始的字节码文件两者大小是完全相同的：

![bytes-similar](../../_assets/misc-other-figure-bytes-similar.png)
...
![extract-payload](../../_assets/misc-other-figure-extract-payload.png)

我们构造的 `Payload` 不一定要是一个 `ASCII` 字符串， `shellcode` 也是可以的：

![payload-shellcode](../../_assets/misc-other-figure-payload-shellcode.png)
...
![example](../../_assets/misc-other-figure-example.png) 

我们可以查看嵌入 `Payload` 之前和之后的 `Python` 代码运行情况：

![example-run](../../_assets/misc-other-figure-example-run.png)

通过 `strings` 查看 `Stegosaurus` 嵌入了 `Payload` 之后的文件输出情况( `payload` 并没有显示出来)：

![strings](../../_assets/misc-other-figure-strings.png)
