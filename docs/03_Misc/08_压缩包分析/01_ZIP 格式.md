...
-   `Windows`下的神器 [ARCHPR](https://www.elcomsoft.com/archpr.html)
    ...
    ![](../../_assets/misc-archive-figure-1.png)
...
![](../../_assets/misc-archive-figure-2.png)
...
![readme](../../_assets/misc-archive-figure-readme.png)
...
![compare](../../_assets/misc-archive-figure-compare.png)
...
![install-pkcrack](../../_assets/misc-archive-figure-install-pkcrack.png)
...
![pkcrack-to-flag](../../_assets/misc-archive-figure-pkcrack-to-flag-01.png)

![pkcrack-to-flag](../../_assets/misc-archive-figure-pkcrack-to-flag-02.png)

![pkcrack-to-flag](../../_assets/misc-archive-figure-pkcrack-to-flag-03.png)

![pkcrack-to-flag](../../_assets/misc-archive-figure-pkcrack-to-flag-04.png)
...
![success](../../_assets/misc-archive-figure-success.jpg)

我相信很多朋友在用 `ARCHPR` 的时候遇到以下这种情况：

![error](../../_assets/misc-archive-figure-error.png)
...
![attack-success](../../_assets/misc-archive-figure-attack-success.png)
...
![](../../_assets/misc-archive-figure-4.png)

再打开文件发现已要求输入密码。

![](../../_assets/misc-archive-figure-5.png)
...
![](../../_assets/misc-archive-figure-3.png)
