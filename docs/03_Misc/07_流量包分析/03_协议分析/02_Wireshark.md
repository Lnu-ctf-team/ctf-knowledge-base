...
1. 借助于过滤器窗口
   ...
   ![filter_window](../../../_assets/misc-traffic-protocols-figure-filter_window.png)

2. 借助于工具条的输入栏

   ![filter_tool](../../../_assets/misc-traffic-protocols-figure-filter_tool.png)

3. 将数据包某个属性值指定为过滤条件

   ![filter_select](../../../_assets/misc-traffic-protocols-figure-filter_select.png)
...
![pro_his](../../../_assets/misc-traffic-protocols-figure-pro_his.png)
...
![Conversation](../../../_assets/misc-traffic-protocols-figure-conversation.png)
...
![points](../../../_assets/misc-traffic-protocols-figure-points.png)

#### HTTP

- Packet Counter

  ![pac_count](../../../_assets/misc-traffic-protocols-figure-pac_count.png)
